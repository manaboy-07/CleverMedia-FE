...
const SignUp = () => {
    return (
      ...
      <div className="p-2 m-2 max-w-2xl  bg-clip rounded-xl" style={{ 
        ...
        <div className=" backdrop-blur-xl backdrop-opacity-90 max-w-lg m-10 rounded-md">
          <h1 className="mt-12 text-2xl font-bold">📡 Class Media</h1>
      ...
      <div className="p-2 m-2">
        <h2 className="text-3xl">Welcome to Class Media</h2>
